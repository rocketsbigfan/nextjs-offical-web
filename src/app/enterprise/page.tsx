...
const QuestionList = [
  {
    header: '大型企业如何进行管理？',
    text: '企业领导者必须确保他们的合作伙伴具备足够的行业专业知识，了解他们行业的独特需求。尤其是提供技术解决方案的合作伙伴，满足这一点要求尤为重要。Wm OS  能否解决你所面临的独特问题？我们提供的功能能否为你创造竞争优势？我们的解决方案能否帮助你实现扩展和创新？答案是肯定的。Wm OS  提供行业特定的产品和服务，旨在满足每个企业的独特需求。我们每天与不同的行业领导者打交道，从他们的反馈中获得灵感和启发，从而不断创新，促进产品更新换代，满足不断变化的客户需求。'
  },
  {
    header: '大型企业如何管理员工？',
    text: 'Wm OS将以人为本的全新理念融入到了人力资本管理中。借助 Wm OS 人力资本管理系统应用，企业不仅能够为员工提供良好的体验，让他们感受到自身价值受到重视，还能不断激发员工的工作热情，让他们发挥最佳工作状态。此外，你可以高效地招募、培训和管理你的员工，并且将员工反馈与运营数据相结合，了解员工的感受和背后的原因，最终打造卓越的员工体验。'
  },
  {
    header: '什么是专精特新大型企业？',
  ...
  {
    header: '什么是业务流程自动化？',
    text: '对于任何企业来说，业务流程自动化都是数字化转型之旅的重要基石。Wm OS可以与前端和后端应用相集成，简化各个流程，包括供应链、HR、财务和客户服务等等。'
  },
  {
        ...
        <div className="max-w-[1440px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="col-span-1 mt-20">
              ...
              <p className="text-base font-normal">中国“专精特新”企业必须要进行数字化转型，才能支撑企业实现可持续发展，帮助其在快速变化的环境中抓住机遇，实现跨量级发展。Wm 助力大型企业实现高质量的数字化转型，为企业提供集成式的企业ERP、CRM、供应链管理及业务技术平台等应用，使企业持续保持领先地位。</p>
            </div>
            <div className="col-span-1 mt-20">
